...
export class SellSendService {
  ...
  createSellSend(numTr: string, bcpAccount: string, email: string, photo: File, tCambio: string, amount: string, token: string){
    ...
    fd.append('sell_amount', amount);
    fd.append('sell_token', token);
